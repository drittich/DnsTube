...
ren %PUBLISH_PATH%\TEMP\DnsTube.exe DnsTube-Portable.exe
ren %PUBLISH_PATH%\TEMP\DnsTube.pdb DnsTube-Portable.pdb
...
ren %PUBLISH_PATH%\TEMP\DnsTube.exe DnsTube-Portable-SelfContained.exe
ren %PUBLISH_PATH%\TEMP\DnsTube.pdb DnsTube-Portable-SelfContained.pdb
...
dotnet publish --nologo -r win-x64 -c Release --self-contained false -o %PUBLISH_PATH%\TEMP
ren %PUBLISH_PATH%\TEMP\DnsTube.exe DnsTube.exe
ren %PUBLISH_PATH%\TEMP\DnsTube.pdb DnsTube.pdb
...
dotnet publish --nologo -r win-x64 -c Release --self-contained true -p:PublishSingleFile=false -o %PUBLISH_PATH%\TEMP
ren %PUBLISH_PATH%\TEMP\DnsTube.exe DnsTube-SelfContained.exe
ren %PUBLISH_PATH%\TEMP\DnsTube.pdb DnsTube-SelfContained.pdb
